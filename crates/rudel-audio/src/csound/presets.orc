; presets.orc, vendored verbatim from @strudel/csound (AGPL-3.0-or-later,
; Felix Roos). Compiled at Csound start so `.csound()` with no orchestra of
; its own still makes a sound, exactly as upstream does.
